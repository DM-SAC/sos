...
function initializeHomeMap() {
	...
	var myOptions = {
		zoom: 15,
		center: new google.maps.LatLng(-12.1185205,-77.036977),
	...
	google.maps.event.addListener(home_map, 'click', function() {
		window.location.href = "propiedad.php";
	});
...
function initializePropertiesMap() {
	if($('#map_canvas').length == 0)
		return;
	var myLatlng = new google.maps.LatLng(-12.169901333333334000,-76.940048000000000000);
	var myOptions = {
		zoom: 13,
		center: myLatlng,
		mapTypeId: google.maps.MapTypeId.ROADMAP
	...
	$.each(map_locations, function(key, value) { 
		...
		google.maps.event.addListener( marker, 'click', function() {
			...
			var content = '<div id="info" class="span5"><div class="row">' + '<div class="span2"><img src="css/images/house_'+(key+1)+'.jpg" class="thumbnail" style="width:135px"/></div>' + '<div class="span3"><h3>' + value['title'] + '</h3><h6>' + value['street'] + '</h6>' + '<strong>&pound;' + value['price'] + '</strong>' + '<p><a href="propiedad.php">Leer mas >></a></p>' + '</div></div></div>';
